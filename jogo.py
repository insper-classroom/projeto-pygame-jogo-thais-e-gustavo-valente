...
class Fundo:
    ...
    def defineSprite(self, corf):
        ...
        cor = colorsys.hsv_to_rgb(corf, 1, 1)
        copia.fill((cor[0]*80, cor[1]*20, cor[2]*70), special_flags = pygame.BLEND_ADD)
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.images = []
        for i in range(12):
            img = pygame.image.load(f'assets/img/coins - bg/coin0{str(i)}.png')
